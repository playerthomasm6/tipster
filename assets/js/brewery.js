    ...
    function displayMovieInfo() {
        ...
        $.ajax({
           ...
           console.log(response)
            ...
            // Brewery API request
            var queryURL = "https://sandbox-api.brewerydb.com/v2/beer/random/?year" + beerYear + "&abv=" + abv + "&srmId=10&key=4952f70986ff85965585395731129d9a";
